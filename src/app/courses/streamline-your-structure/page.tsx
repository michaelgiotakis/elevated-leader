        ...
        <div className="flex flex-col lg:flex-row lg:min-h-[820px] xl:min-h-[860px]">
          ...
          >
            <Image
              ...
              priority
              placeholder="blur"
              blurDataURL="data:image/svg+xml;base64,PHN2ZyB4bWxucz0naHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmcnIHdpZHRoPSc4JyBoZWlnaHQ9JzgnPjxyZWN0IHdpZHRoPSc4JyBoZWlnaHQ9JzgnIGZpbGw9JyMxRTFDMTknLz48L3N2Zz4="
            />
